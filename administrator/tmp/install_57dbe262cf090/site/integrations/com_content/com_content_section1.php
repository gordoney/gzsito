...
require_once( dirname( __FILE__ ) . DIRECTORY_SEPARATOR . 'com_content.php' );

class JUCommentComcontentSection1 extends JUCommentComcontent
{
	public function __construct( $component, $section = 'section1' )
	{
