...
<div class="captcha-box">
	<div class="clearfix">
		...
		<span class="input-group col-sm-2">
			<input type="text" <?php echo $input_id; ?> name="<?php echo $response_name;?>" class="captcha-response <?php echo $input_class; ?> form-control" <?php echo $validate_data; ?> />
			<span title="<?php echo JText::_('COM_JUCOMMENT_RELOAD_CAPTCHA'); ?>" class="input-group-addon btn jucomment-captcha-reload"><i class="fa fa-refresh"></i></span>
		</span>
