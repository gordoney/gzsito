		...
		<div id="<?php echo "comment-box-".$row->id; ?>" class="comment-box clearfix">
			...
			<div class="comment-text">
				...
				<div class="comment-actions clearfix">
					...
					<a class="btn btn-default btn-xs vote-up <?php echo $vote_up_class; ?>"
						href="#"><i class="fa fa-thumbs-o-up"></i></a>
						<span class="btn btn-default btn-xs vote-counter"><?php echo $vote_counter; ?> </span>
					<a class="btn btn-default btn-xs vote-down <?php echo $vote_down_class; ?>"
					...
					<?php if ($system->permission->allow('reply', $row))
					{
						...
						?>
						<a class="btn btn-default btn-xs reply-comment-btn" href="<?php echo $url; ?>" data-fancybox-type="iframe">
					...
					{
						?>
						<a class="btn btn-default btn-xs quote-comment-btn" href="#">
					...
					<?php if ($system->permission->allow('report', $row))
					{
						...
						?>
						<a class="btn btn-default btn-xs report-comment-btn<?php echo $classDisabled; ?>" href="<?php echo $url; ?>" data-fancybox-type="iframe">
					...
					if ($system->permission->allow('edit', $row))
					{
						if ($row->checked_out > 0)
						{
							...
							?>
							<a class="hasTooltip btn btn-default btn-xs comment-edit" title="<?php echo $tooltip; ?>" href="<?php echo $row->checkout_link; ?>">
						...
						else
						{
							...
							?>
							<a class="btn btn-default btn-xs edit-comment-btn" href="<?php echo $url; ?>" data-fancybox-type="iframe">
					...
					{
						?>
							<a class="btn btn-default btn-xs delete-comment-btn" role="button" data-toggle="modal"
