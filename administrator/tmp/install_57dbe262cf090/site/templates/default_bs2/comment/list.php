...
<div class="jucm-comment-list">
	<h3 class="total-comments clearfix">
		...
		{ ?>
			<a style="float: right; margin-top: 10px" class="btn btn-small comment-subscription-btn"  role="button" class="btn" data-toggle="modal"
